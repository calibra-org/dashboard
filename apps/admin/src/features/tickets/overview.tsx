                    ...
                    <CardContent>
                        ...
                        <div className="mt-3 flex items-center gap-4 text-muted-foreground text-xs">
                            <span className="inline-flex items-center gap-1.5">
                                <span className="size-2 rounded-full bg-primary" /> {locale === "en" ? "Opened" : "ایجادشده"}
                            </span>
                            <span className="inline-flex items-center gap-1.5">
                                <span className="size-2 rounded-full bg-success" /> {locale === "en" ? "Resolved" : "حل‌شده"}
                            </span>
                        </div>
                    </CardContent>
                </Card>
                        ...
                        <div className="grid gap-2 lg:grid-cols-2">
                            {recent.map((ticket) => (
                                <Link
                                    ...
                                    className="group rounded-xl border p-3 transition-colors hover:bg-muted/45"
                                >
                ...
                <Card className="shadow-sm">
                    ...
                    <CardContent className="space-y-2">
                        ...
                        <div className="pt-1 text-[0.68rem] text-muted-foreground">
                            ...
                            {locale === "en" ? "verified connected" : "کانال با وضعیت متصلِ تأییدشده"}
                        </div>
                    </CardContent>
                </Card>
