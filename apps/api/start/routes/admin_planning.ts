...
router
    .group(() => {
        ...
        router
            .post("/forecast/run", [PlanningController, "runForecast"])
            .as("admin.planning.forecast.run")
        ...
        router
            .post("/accuracy/refresh", [PlanningController, "refreshAccuracy"])
            .as("admin.planning.accuracy.refresh")
            .use(adminWriteLimiter);
        ...
        router
            .post("/cycles/:id/transition", [PlanningController, "transitionCycle"])
            .as("admin.planning.cycles.transition")
            .use(adminWriteLimiter);
        router.get("/scenarios", [PlanningController, "scenarios"]).as("admin.planning.scenarios.index");
        router
            .post("/scenarios", [PlanningController, "createScenario"])
            .as("admin.planning.scenarios.create")
            .use(adminWriteLimiter);
        ...
        router
            .post("/overrides", [PlanningController, "createOverride"])
            .as("admin.planning.overrides.create")
            .use(adminWriteLimiter);
        router
            .post("/overrides/:id/review", [PlanningController, "reviewOverride"])
