...
router
    .group(() => {
        ...
        router.get("/:id/intelligence-definition", [AdminCustomerSegmentsController, "definition"]).as("admin.customer-segments.definition");
        router.put("/:id/intelligence-definition", [AdminCustomerSegmentsController, "saveDefinition"]).as("admin.customer-segments.definition.update");
