...
router
    .group(() => {
        ...
        router
            .post("/suppliers", [ProcurementController, "createSupplier"])
            .as("admin.procurement.suppliers.create")
        ...
        router
            .post("/purchase-orders", [ProcurementController, "createPurchaseOrder"])
            .as("admin.procurement.purchase-orders.create")
            .use(adminWriteLimiter);
        router
            .post("/purchase-orders/:id/transition", [ProcurementController, "transition"])
            .as("admin.procurement.purchase-orders.transition")
            .use(adminWriteLimiter);
        router
            .post("/purchase-orders/:id/receipts", [ProcurementController, "receive"])
            .as("admin.procurement.purchase-orders.receive")
            .use(adminWriteLimiter);
