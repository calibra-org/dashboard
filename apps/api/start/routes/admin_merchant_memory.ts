...
router
    .group(() => {
        ...
        router
            ...
            .use(adminWriteLimiter);
        router.post("/retrieve", [MerchantMemoryController, "retrieve"]).as("admin.merchant_memory.retrieve");
        router
            .post("/memories/:publicId/effectiveness", [MerchantMemoryController, "effectiveness"])
