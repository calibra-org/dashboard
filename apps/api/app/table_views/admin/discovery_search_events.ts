...
export const adminDiscoverySearchEventsView = createTableView({
    ...
    columns: {
        ...
        event_type: { type: "string", filterable: true, orderable: true },
        locale: { type: "string", filterable: true, orderable: false },
        surface: { type: "string", filterable: true, orderable: false },
        normalized_query: { type: "string", filterable: true, orderable: true },
        intent: { type: "string", filterable: true, orderable: false },
        result_count: { type: "number", filterable: true, orderable: true },
