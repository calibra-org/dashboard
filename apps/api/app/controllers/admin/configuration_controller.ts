...
export default class AdminConfigurationController {
    ...
    async applyBlueprint(ctx: HttpContext) {
        ...
        if (!checked.valid) {
            return ctx.response.unprocessableEntity({
                errors: [{ message: "Invalid configuration blueprint", rule: "configuration.blueprint.invalid", details: checked.errors }],
            });
        }
    ...
    private changeInput(ctx: HttpContext): ConfigurationChangeInput {
        ...
        return {
            ...
            expires_at:
                typeof body.expires_at === "string" ? body.expires_at : body.expires_at === null ? null : undefined,
            approval_reference:
