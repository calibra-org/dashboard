...
export default class AdminSettingsBrandingController {
    ...
    private planWrites(payload: BrandingSettingsPayload): PlannedWrite[] {
        ...
        if (payload.logo_media_id !== undefined) writes.push({ key: "logo_media_id", value: payload.logo_media_id, type: "json" });
        if (payload.favicon_media_id !== undefined) writes.push({ key: "favicon_media_id", value: payload.favicon_media_id, type: "json" });
