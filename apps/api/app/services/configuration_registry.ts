...
const GROUP_META: Record<ConfigurationGroup, GroupMeta> = {
    general: { category: "site", mode: "hybrid", labelFa: "عمومی و هویت سایت", labelEn: "General & Site Identity", descriptionFa: "هویت، منطقه، ارز و سیاست‌های عمومی سایت", descriptionEn: "Identity, regional, currency and general site policy", href: "/settings/general" },
    publishing: { category: "site", mode: "settings", labelFa: "انتشار", labelEn: "Publishing", descriptionFa: "پیش‌فرض‌های نوشتن و انتشار محتوا", descriptionEn: "Writing and publishing defaults", href: "/settings/configuration/publishing" },
    reading: { category: "site", mode: "settings", labelFa: "خواندن و صفحه اصلی", labelEn: "Reading & Homepage", descriptionFa: "صفحه اصلی، فید و ماژول‌های composable", descriptionEn: "Homepage, feed and composable modules", href: "/settings/configuration/reading" },
    community: { category: "communications", mode: "settings", labelFa: "دیدگاه و جامعه", labelEn: "Discussion & Community", descriptionFa: "دیدگاه، بازبینی و moderation", descriptionEn: "Review, discussion and moderation policy", href: "/settings/configuration/community" },
    media: { category: "site", mode: "hybrid", labelFa: "رسانه", labelEn: "Media & DAM", descriptionFa: "پیش‌فرض‌های رسانه با اتصال به دامنه Media", descriptionEn: "Media policy linked to the canonical Media domain", href: "/settings/media" },
    urls: { category: "site", mode: "settings", labelFa: "پیوندها و URL", labelEn: "Permalinks & URL Governance", descriptionFa: "URL Safety Engine، preview و redirect evidence", descriptionEn: "URL Safety Engine, preview and redirect evidence", href: "/settings/configuration/urls" },
    catalog: { category: "commerce", mode: "hybrid", labelFa: "کاتالوگ", labelEn: "Catalog", descriptionFa: "پیش‌فرض نمایش بدون duplicate محصول و taxonomy", descriptionEn: "Display defaults without duplicating products/taxonomy", href: "/settings/configuration/catalog" },
    inventory: { category: "commerce", mode: "hybrid", labelFa: "موجودی", labelEn: "Inventory Defaults", descriptionFa: "پیش‌فرض‌های سیاست موجودی بدون stock ledger موازی", descriptionEn: "Inventory policy defaults without a parallel stock ledger", href: "/settings/configuration/inventory" },
    tax: { category: "commerce", mode: "hybrid", labelFa: "مالیات", labelEn: "Tax Configuration", descriptionFa: "سیاست و simulator با reuse دامنه Tax", descriptionEn: "Policy and simulator reusing the canonical Tax domain", href: "/settings/configuration/tax" },
    shipping: { category: "commerce", mode: "hybrid", labelFa: "ارسال", labelEn: "Shipping Configuration", descriptionFa: "پیش‌فرض‌ها با اتصال به zone/method واقعی", descriptionEn: "Defaults linked to canonical zones/methods", href: "/settings/configuration/shipping" },
    payments: { category: "commerce", mode: "hybrid", labelFa: "پرداخت", labelEn: "Payment Configuration", descriptionFa: "سیاست Checkout با اتصال به درگاه‌های واقعی", descriptionEn: "Checkout policy linked to canonical gateways", href: "/settings/configuration/payments" },
    checkout: { category: "commerce", mode: "settings", labelFa: "تسویه و حساب", labelEn: "Checkout & Accounts", descriptionFa: "سیاست‌های Checkout و حساب", descriptionEn: "Checkout and account policy", href: "/settings/configuration/checkout" },
    notifications: { category: "communications", mode: "settings", labelFa: "اعلان‌ها", labelEn: "Notifications", descriptionFa: "Event Registry و سیاست کانال‌ها بدون duplicate Messaging", descriptionEn: "Event registry and channel policy without duplicating Messaging", href: "/settings/configuration/notifications" },
    privacy: { category: "governance", mode: "settings", labelFa: "حریم خصوصی و رضایت", labelEn: "Privacy, Consent & Legal", descriptionFa: "سیاست رضایت، نسخه‌ها و نگهداری داده", descriptionEn: "Consent, versioning and retention policy", href: "/settings/configuration/privacy" },
    visibility: { category: "governance", mode: "settings", labelFa: "نمایانی و انتشار", labelEn: "Site Visibility & Launch", descriptionFa: "کنترل launch و robots با preview اجباری", descriptionEn: "Launch and robots controls with mandatory preview", href: "/settings/configuration/visibility" },
    integrations: { category: "developer", mode: "settings", labelFa: "API و یکپارچه‌سازی", labelEn: "API, Webhooks & Integrations", descriptionFa: "پیش‌فرض integration و secret referenceهای امن", descriptionEn: "Integration defaults and safe secret references", href: "/settings/configuration/integrations" },
    infrastructure: { category: "developer", mode: "settings", labelFa: "زیرساخت", labelEn: "Infrastructure & Operations", descriptionFa: "تنظیمات محدود و نیازمند permission/approval", descriptionEn: "Restricted configuration requiring permission/approval", href: "/settings/configuration/infrastructure" },
    change_management: { category: "change_management", mode: "settings", labelFa: "مدیریت تغییر", labelEn: "Change Management", descriptionFa: "version، diff، rollback، rollout، blueprint و drift", descriptionEn: "Version, diff, rollback, rollout, blueprint and drift", href: "/settings/configuration/change_management" },
};
...
const LEGACY_SCOPES: Record<"general" | "datetime" | "media" | "branding", Array<{ group: string; key: string; type: SettingValueType }>> = {
    general: [
