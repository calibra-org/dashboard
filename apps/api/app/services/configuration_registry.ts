...
export const configurationDefinitions: readonly ConfigurationSettingDefinition[] = [
    ...
    setting("community", "community.social_story_rail_enabled", "boolean", true, {
        labelFa: "ریل استوری اجتماعی",
        labelEn: "Social story rail",
        descriptionFa: "نمایش استوری‌های تأییدشده Social Commerce.",
        descriptionEn: "Show approved Social Commerce stories.",
        dependencies: ["community", "content", "media"],
        riskLevel: "medium",
    }),
    setting("community", "community.social_discover_enabled", "boolean", true, {
        labelFa: "هاب Discover اجتماعی",
        labelEn: "Social Discover hub",
        descriptionFa: "فعال‌بودن فیدهای Discover فاز ۸؛ شخصی‌سازی به فاز ۹ واگذار می‌شود.",
        descriptionEn: "Enable Phase 8 Discover feeds; personalization remains Phase 9.",
        dependencies: ["community", "catalog"],
        riskLevel: "medium",
    }),
    setting("community", "community.social_live_enabled", "boolean", false, {
        labelFa: "خرید زنده",
        labelEn: "Live shopping",
        descriptionFa: "فعال‌بودن Live Shopping با قیمت و موجودی canonical.",
        descriptionEn: "Enable Live Shopping backed by canonical Catalog/Inventory truth.",
        dependencies: ["community", "catalog", "inventory"],
        riskLevel: "high",
    }),
    setting("community", "community.social_live_provider_enabled", "boolean", false, {
        labelFa: "Provider خرید زنده",
        labelEn: "Live provider",
        descriptionFa: "اجازه provisioning بیرونی برای Live؛ پیش‌فرض خاموش.",
        descriptionEn: "Allow external Live provider provisioning; disabled by default.",
        dependencies: ["community", "integrations"],
        riskLevel: "high",
    }),
    setting("community", "community.social_live_emergency_off", "boolean", false, {
        labelFa: "توقف اضطراری Live",
        labelEn: "Live emergency stop",
        descriptionFa: "کلید اضطراری برای جلوگیری از شروع/ادامه Live.",
        descriptionEn: "Emergency kill switch for starting/progressing Live sessions.",
        dependencies: ["community"],
        riskLevel: "critical",
    }),
    setting("community", "community.social_moderation_emergency_mode", "boolean", false, {
        labelFa: "حالت اضطراری Moderation",
        labelEn: "Moderation emergency mode",
        descriptionFa: "در رخداد ایمنی، انتشار اجتماعی را fail-closed می‌کند.",
        descriptionEn: "Fail-close social publication during a moderation safety incident.",
        dependencies: ["community"],
        riskLevel: "critical",
    }),
    ...
    setting("media", "media.social_uploads_enabled", "boolean", false, {
        labelFa: "بارگذاری رسانه اجتماعی",
        labelEn: "Social media uploads",
        descriptionFa: "کلید انتشار تدریجی upload مستقیم؛ پیش‌فرض خاموش است.",
        descriptionEn: "Rollout kill switch for direct social uploads; disabled by default.",
        dependencies: ["media", "community"],
        riskLevel: "high",
    }),
    setting("media", "media.social_safety_required", "boolean", true, {
        labelFa: "الزام بررسی ایمنی رسانه",
        labelEn: "Require social media safety gate",
        descriptionFa: "رسانه بدون verdict پاک قابل انتشار نیست.",
        descriptionEn: "Require an explicit clean safety verdict before publishable.",
        dependencies: ["media", "community"],
        riskLevel: "high",
    }),
    setting("media", "media.social_max_video_seconds", "number", 900, {
        labelFa: "حداکثر طول ویدئوی اجتماعی",
        labelEn: "Maximum social video duration",
        descriptionFa: "سقف مدت Story/Video/Live replay بر حسب ثانیه.",
        descriptionEn: "Maximum Story/Video/Live replay duration in seconds.",
        validation: { min: 15, max: 14400 },
        dependencies: ["media", "community"],
        riskLevel: "medium",
    }),
