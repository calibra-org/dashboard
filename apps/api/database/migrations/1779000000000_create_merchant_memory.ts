...
export default class extends BaseSchema {
    async up() {
        ...
        const checks = [
            "ALTER TABLE merchant_memories ADD CONSTRAINT merchant_memory_class_check CHECK (memory_class IN ('operational_incident','supplier_lesson','campaign_lesson','pricing_lesson','customer_segment_behavior','product_quality','architecture_process','policy_precedent'))",
            "ALTER TABLE merchant_memories ADD CONSTRAINT merchant_memory_scope_check CHECK (scope_kind IN ('merchant','supplier','campaign','pricing','customer_segment','product','architecture','policy'))",
