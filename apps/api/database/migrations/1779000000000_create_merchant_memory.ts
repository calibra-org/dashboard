...
export default class extends BaseSchema {
    async up() {
        ...
        this.schema.createTable("merchant_memory_retrievals", (table) => {
            ...
            table.index(["tenant_id", "retrieved_at"], "merchant_memory_retrieval_time_idx");
        });
        ...
        const checks = [
            ...
            "ALTER TABLE merchant_memory_sources ADD CONSTRAINT merchant_memory_source_kind_check CHECK (source_kind IN ('decision','outcome','approval','experiment','portfolio','incident','audit','operator'))",
