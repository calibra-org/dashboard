...
export default class extends BaseSchema {
    async up() {
        this.schema.createTable("merchant_memory_records", (table) => {
            ...
            table.string("retention_class", 40).notNullable().defaultTo("learned_fact");
        ...
        this.schema.createTable("merchant_memory_sources", (table) => {
            ...
            table.string("source_domain", 80).notNullable();
            ...
            table.index(["tenant_id", "memory_id", "observed_at"], "merchant_memory_source_memory_idx");
