...
export default class extends BaseSchema {
    async up() {
        ...
        this.schema.raw("ALTER TABLE seo_crawl_targets ALTER COLUMN tenant_id SET DEFAULT NULLIF(current_setting('app.current_tenant', true), '')::bigint");
        ...
        this.schema.raw("ALTER TABLE seo_crawl_targets ADD CONSTRAINT seo_crawl_targets_status_check CHECK (status IN ('queued','processing','completed','failed'))");
        this.schema.raw("ALTER TABLE seo_crawl_targets ADD CONSTRAINT seo_crawl_targets_attempts_check CHECK (attempts BETWEEN 0 AND 5)");
    }
