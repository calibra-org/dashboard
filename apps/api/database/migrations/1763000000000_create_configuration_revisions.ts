...
export default class extends BaseSchema {
    async up() {
        this.schema.createTable("configuration_revisions", (table) => {
            ...
            table.unique(["tenant_id", "scope_key", "revision"], { indexName: "configuration_revisions_tenant_scope_revision_unique" });
        ...
        this.schema.raw(`CREATE POLICY configuration_revisions_tenant_isolation ON configuration_revisions USING (${TENANT_PREDICATE}) WITH CHECK (${TENANT_PREDICATE})`);
    }
