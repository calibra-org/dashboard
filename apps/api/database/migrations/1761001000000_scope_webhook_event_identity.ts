 ...
 *
 * Lucid's schema builder queues DDL for the migration runner. Do not await `this.schema.raw(...)`
 * here: awaiting the mutable schema builder executes the queued statements early and the runner
 * will execute the accumulated builder again, which can create the replacement index twice.
 */
