...
export interface components {
    schemas: {
        ...
        ConfigurationDiffEntry: { key: string; before: unknown; after: unknown; before_exists: boolean; after_exists: boolean };
        ...
        ConfigurationRollbackEnvelope: { data: components["schemas"]["ConfigurationRevisionDetail"]; meta: { changed: boolean } };
    };
}

export interface paths {
    "/api/v1/admin/settings/configuration/registry": { get: operations["adminPhase6ConfigurationRegistry"] };
    "/api/v1/admin/settings/configuration/history": { get: operations["adminPhase6ConfigurationHistory"] };
    "/api/v1/admin/settings/configuration/history/{scope}/{revision}": { get: operations["adminPhase6ConfigurationRevisionShow"] };
    "/api/v1/admin/settings/configuration/history/{scope}/{revision}/rollback": { post: operations["adminPhase6ConfigurationRollback"] };
}

export interface operations {
    adminPhase6ConfigurationRegistry: { responses: { 200: { content: { "application/json": components["schemas"]["ConfigurationCapabilityEnvelope"] } } } };
