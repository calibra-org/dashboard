...
class DesignSystemGenerator:
    ...
    def _apply_reasoning(self, category: str) -> dict:
        """Apply reasoning rules for the detected category."""
...
def _slugify(value: str) -> str:
    """Create filesystem-safe slugs for project and page names."""
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    ...
    project_name = design_system.get("project_name", page_query or "default")
    ...
    if page:
        page_file = pages_dir / f"{_slugify(page)}.md"
...
def format_master_md(design_system: dict, project_slug: str = None) -> str:
    ...
    project = design_system.get("project_name", "PROJECT")
    project_slug = project_slug or design_system.get("project_slug") or _slugify(project)
    pattern = design_system.get("pattern", {})
    style = design_system.get("style", {})
    colors = design_system.get("colors", {})
    typography = design_system.get("typography", {})
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None, project_slug: str = None) -> str:
    ...
    page_overrides = _generate_intelligent_overrides(page_name, page_query)
...
def _generate_intelligent_overrides(page_name: str, page_query: str) -> dict:
    """
