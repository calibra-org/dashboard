...
scripts["build:json:admin-phase30"] = "redocly bundle reference/openapi/admin.phase30.v1.yaml --output dist/admin.phase30.v1.json";
...
if (!adminParts.includes("build:json:admin-phase30")) scripts["build:json:admin-parts"] = `${adminParts} && pnpm build:json:admin-phase30`;
