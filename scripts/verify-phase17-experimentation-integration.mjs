...
const checks = [
    [
        "migration",
        "apps/api/database/migrations/1768000000000_create_phase17_experimentation_lab.ts",
        [
    ...
    [
        "service",
        "apps/api/app/services/phase17_experimentation_service.ts",
        [
            "deterministicBucket",
            "persistent_holdout",
            "srm_detected",
    ...
    [
        "admin ui",
        "apps/admin/src/features/experiments/ExperimentationWorkspace.tsx",
        ["Assignment ≠ Exposure", "Guardrail", "Causal Memory", "Persistent Holdouts"],
    ],
    [
        "queries",
        "apps/admin/src/lib/queries/experiments.ts",
        ["useExperimentOverview", "useAnalyzeExperiment", "useCreateHoldout"],
    ],
    [
        "openapi",
        "docs/api/reference/openapi/admin.phase17.v1.yaml",
        ["/api/v1/admin/experiments", "/api/v1/admin/experiments/{id}/analyze"],
    ],
];
...
if (
    !routes.includes('await import("./routes/admin_experiments.js")') ||
    !routes.includes('await import("./routes/experiments.js")')
)
    throw new Error("Phase 17 route registry imports are missing");
