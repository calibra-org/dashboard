...
must(migration.includes("source_phase IN ('phase10','phase11','phase17','phase22','phase25','manual_reviewed')"), "source phase allowlist missing");
...
must(!service.includes("chat_history") && !service.includes("conversation_history"), "chat transcript must not become memory authority");
